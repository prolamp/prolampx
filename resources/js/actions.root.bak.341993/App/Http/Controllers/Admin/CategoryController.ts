...
* @see app/Http/Controllers/Admin/CategoryController.php:31
...
* @see app/Http/Controllers/Admin/CategoryController.php:36
* @route '/admin/categories'
*/
...
/**
* @see \App\Http\Controllers\Admin\CategoryController::toggleActive
* @see app/Http/Controllers/Admin/CategoryController.php:76
* @route '/admin/categories/{category}/toggle-active'
*/
export const toggleActive = (args: { category: number | { id: number } } | [category: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
...
toggleActive.definition = {
    methods: ["patch"],
    url: '/admin/categories/{category}/toggle-active',
...
* @route '/admin/categories/{category}/toggle-active'
*/
toggleActive.url = (args: { category: number | { id: number } } | [category: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { category: args }
    }
...
* @route '/admin/categories/{category}/toggle-active'
*/
toggleActive.patch = (args: { category: number | { id: number } } | [category: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: toggleActive.url(args, options),
    method: 'patch',
})
...
* @route '/admin/categories/{category}/toggle-active'
*/
const toggleActiveForm = (args: { category: number | { id: number } } | [category: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/categories/{category}/toggle-active'
*/
toggleActiveForm.patch = (args: { category: number | { id: number } } | [category: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: toggleActive.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PATCH',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const CategoryController = { index, create, store, show, edit, update, destroy, toggleActive }
